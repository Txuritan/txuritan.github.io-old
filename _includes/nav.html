        ...
        <a class="sidebar-toggle" data-toggle="offcanvas" role="button">
            ...
            <!--<div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="http://nezurick.deviantart.com/"><i class="fa fa-deviantart"></i></a>
                    </li>
                    <li>
                        <a href="https://github.com/Txuritan"><i class="fa fa-github"></i></a>
                    </li>
                    <li>
                        <a href="https://plus.google.com/u/0/115091787142248750574/posts"><i class="fa fa-google-plus"></i></a>
                    </li>
                    <li>
                        <a href="https://soundcloud.com/dj-lamia"><i class="fa fa-soundcloud"></i></a>
                    </li>
                    <li>
                        <a href="http://steamcommunity.com/id/aurtik/"><i class="fa fa-steam"></i></a>
                    </li>
                    <li>
                        <a href="http://txuritan.tumblr.com/"><i class="fa fa-tumblr"></i></a>
                    </li>
                    <li>
                        <a href="http://www.twitch.tv/txuritan/profile"><i class="fa fa-twitch"></i></a>
                    </li>
                    <li>
